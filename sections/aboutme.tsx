...
export default function AboutMe() {
  ...
  return (
    ...
    >
      <div data-aos="fade-down" className="flex justify-between px-4 py-1 mb-6 border border-line w-36 rounded-3xl">
        <svg
      ...
      <div className="flex flex-col justify-center">
        <h1 data-aos="fade-down" className="mb-10 lg:mt-20 font-sans  text-3xl tracking-wide font-bold dark:text-text-color text-[#404040] sm:text-5xl sm:leading-none">
          ...
          <span className="text-transparent text-accent-color bg-gradient-to-r from-gradient-start via-gradient-min to-gradient-end bg-clip-text">Captivating Story</span>
        </h1>
        <h3 data-aos="fade-down" className="inline-block max-w-5xl text-base tracking-widest text-justify opacity-75 text-maven-blue">
          With <span className="text-3xl text-transparent text-accent-color bg-gradient-to-r from-gradient-start via-gradient-min to-gradient-end bg-clip-text">2 years</span> of
        ...
        <br />
        <h3 data-aos="fade-down" className="inline-block max-w-5xl mt-10 text-base tracking-widest text-justify opacity-75 text-maven-blue">
